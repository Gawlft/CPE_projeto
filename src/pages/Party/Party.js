    ...
    return (
        ...
        <div className="EstruturasFisicas">
            <div className="estruturasMain">
                <hi>EstruturasFísicas</hi>
            </div>
            <div className="cozinhaBox">
                <div className="textocozinha">
                    <h2>Cozinha: onde bate o coração da festa</h2>
                    <h4>Desde a primeira Festa da Polenta, em 1979, a cozinha vem evoluindo, com aquisições de utensílios e aprimoramento na sua organização e no treino dos voluntários, cada vez mais capacitados para produzir com qualidade e em quantidade. 
...
Em 2011, o prato típico passou para bandejas fechadas, mais higiênicas e céleres no preparo e transporte, fator que otimizou o trabalho na cozinha.
            ...
            <div className="tomboBox">
                <div className="texttombo">
                    ...
                    <h4>O 'Tombo da Polenta Gigante', foi um alívio para a cozinha, pois são preparados mais de 1.200 quilos de polenta por vez, abastecendo a cozinha na versão mole e dura para fritar. O tombo da polenta, já foi para o Guinness Book de 2008, e é um ponto atrativo da Festa. Foi criado a partir da ideia do Presidente Tarcísio José Caliman
</h4>
                </div>
            </div>
